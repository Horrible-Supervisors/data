...
#SBATCH --output=/home/jrick6/repos/data/logs/imagenette/set4/shard5/%x.%A.%a.out
...
/home/jrick6/.conda/envs/simclr/bin/python generate_image_variations.py \
    ...
    -o "/home/jrick6/tensorflow_datasets/imagenette_id_variations4/full-size-v2/1.0.0/dir_imagenette-train.tfrecord-00005-of-00016/imagenette-train.tfrecord-00005-of-00016" \
